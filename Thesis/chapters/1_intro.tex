\chapter{Introduction} \label{chp:intro}
    ...
    \section{Summary and direction of work in this thesis}
        ...
        \]
        \textcolor{red}{Prof. Higgins comment: Would be better to explain the range over which a laser can be focused.}
