\chapter{Experiments}
    ...
    \section{Optical design}
        ...
        \subsection{Going from QCW to CW LSP}
            ...
            The following figure presents the QCW LSP initiation attempts in V2 with focus distance. \qty{20}{bar} of argon was used for these shots.
            \begin{figure}[!ht]
                \centering
    ...
    \section{V2 Cold flow thruster characterization}
        ...
        \subsection{Cold flow thrust tests}
            ...
            Cold flow tests (laser off) were completed with V2 to give a baseline measurement of thrust before eventual hot fire tests (laser on), and to validate the functioning of all data acquisition systems. %Refer to appendix for Omega pressure sensor calibration \todo{Add pressure sensor calibration in appendix}.
