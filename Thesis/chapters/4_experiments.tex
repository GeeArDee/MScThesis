\chapter{Experiments}
    ...
    \section{Static laser-sustained plasma validation}
        ...
        \subsection{Seeding argon with \ce{NO2}}
        ...
        \subsection{Spark initiation of plasma in version 2 and quasi-continuous wave laser-sustained plasma}
    ...
    \section{Version 2 cold flow thruster characterization}
    ...
    \sectionmark{Initial QCW LSP thrust tests (hot fire)}
