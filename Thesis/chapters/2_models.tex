\chapter{0D LSP Model} \label{chp:models}
    ...
    \section{Model setup}
        ...
        \begin{enumerate}
            \item The volume and the mass of a cone of pure argon is found at the initial temperature (\qty{300}{K}) and pressure (\qty{20}{bar}). This will be the mass of argon plasma $m_\mathrm{plasma}$ and will remain fixed for the rest of the problem \todo{This could be source of error, as plasma mass increases}
                \begin{equation}
                    huh
                \end{equation}
            \item Energy from the laser pulse is added to the cone at constant pressure and the new temperature at this step is found ($T_2$)
                ...
                \end{equation}
                \begin{equation}
                    m_\mathrm{plasma} (h_2 - h_1) = E_\mathrm{laser}
                \end{equation}
