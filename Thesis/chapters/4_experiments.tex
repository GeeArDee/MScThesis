\chapter{Experiments: methodology and results}
    ...
    \section{Static LSP validation}
        ...
        \subsection{V1 LSP spark initiation}
            ...
            \begin{figure}[!ht]
                \centering
                \includegraphics[width=0.5\textwidth]{assets/4 experiments/Composite photo spark.png}
    ...
    \section{Cold flow thruster characterisation}
        ...
        \subsection{Cold flow thrust tests}
            ...
            % TO-DO:
            \missingfigure{cold flow thrust curve at 20 bar}
            \missingfigure{cold flow thrust vs pressure relation graph with 35 points}
