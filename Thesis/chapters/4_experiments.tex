\chapter{Experiments}
    ...
    \section{Static LSP validation}
        ...
        \subsection{\ce{NO2} seeding}
            ...
            \textcolor{red}{Gabriel: I could do this, but I have not explored these concepts yet.}
    ...
    \section{V2 Cold flow thruster characterization}
        ...
        \subsection{Cold flow thrust tests}
            ...
            The empirical relation of pressure versus thrust is given \todo{Only 5 points is a bit thin to say it's linear, but I don't have more points. We planned to do 35 but didn't have time.}by:
            \[
        ...
        \subsection{Thruster nozzle effective sonic area $A^*$}
            ...
            To determine the mass flow rate $\dot{m}$ of the thruster, \todo{A flow meter was not used because we did not have one} sonic isentropic flow at the nozzle throat was assumed. The following equation can then be used:
            \begin{equation}
