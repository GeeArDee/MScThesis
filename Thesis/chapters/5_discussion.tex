...
With these problems solved, reliable spark initiation of LSP was achieved in V1. \ce{NO2} seeding tests were then undertaken to determine if more laser energy could be captured by the propellant. With as low as (0.6\%) of \ce{NO2} mixed with argon, double the pressure rise was observed. This indicated that the propellant was absorbing twice the energy from the plasma. As the \ce{NO2} fraction was increased, there were diminishing returns to the pressure rise. This was encouraging, as not much \ce{NO2} is needed to have a great impact on the energy absorption.
