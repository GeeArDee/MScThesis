\chapter{Experiments}
    ...
    \section{Optical design}
        ...
        \subsection{V1 Bringing the pulsed power down and optical design} \label{sec:pulse_power_down_V1}
            ...
            %Not true: The completion of these tests validated LSP generation in the CW power regime of the laser. The V2 thruster was then set up to test CW operation with flowing argon.
