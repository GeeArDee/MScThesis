\chapter{Experiments}
    ...
    \section{Cold flow thruster characterisation}
        ...
        \subsection{Needle valve effective sonic area $A^*$}
            ...
            \begin{figure}[!ht]
                \centering
                \includegraphics[width=0.75\textwidth]{assets/4 experiments/Bubble meter.png}
        ...
        \subsection{Mass flow rate $\dot m$}
            ...
            \todo{MOVE TO FUTURE WORK add experiment with me and Tariq}
        ...
        \subsection{Summary of results}
            ...
            \begin{table}[!ht]
                ...
                Average cold flow thrust at 20 bar &     \todo{value}          
                \end{tabularx}
            \end{table}
