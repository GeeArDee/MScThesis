...
With V1, spark initiation was first attempted with an initiation plug that could fit into a single port \todo{photo}. The electrodes were side by side. However, the spark moved around too much for initiation to be reliable.

%Going from side-by-side electrodes to opposing ports
% TO BE COMPLETED
...
With these problems solved, spark initiation of LSP was achieved in V1 \todo{When?}. 


A new test section, named V2, was therefore designed over the course of two semesters. 
