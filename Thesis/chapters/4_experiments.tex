\chapter{Experiments}
    ...
    \section{Static LSP validation}
        ...
        \subsection{Optical experiments: going from QCW to CW LSP}
            ...
            \end{figure}
            \todo{interpret graph, talk about way forward} Initiation at \qty{11}{\%} was attained once, but it was not possible to replicate this. A tighter focus was necessary to increase initiation \todo{add to this} reliability, and a dual-lens system was designed.
        ...
        \subsection{V2 CW LSP}
            ...
            \autoref{fig:CW pressure rise} shows the pressure rise recorded by the PCB transducer connected to the oscilloscope. This was the first CW LSP generated in the lab. \todo{make better graph} Minimal damage to the window was noticed after this test.
