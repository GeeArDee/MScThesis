...
% Discussion on acheivement of V2 CW LSP: while these results are encouraging, more experiments with CW laser operation must be completed to determine if lifetimes can be extended an order of magnitude more, i.e. around one second.
