\chapter{Introduction} \label{chp:intro}
    ...
    \section{Literature review}
        ...
        \begin{figure}[!ht]
            ...
            \caption{Experimental apparatus from \textcite{keeferPowerAbsorptionLasersustained1986a}, with permission.}
        ...
        \end{figure}
        These two-dimensional temperature maps [INSERT EXPLANATION HERE]. Thermal efficiency was between \qtyrange{6}{25}{\%}, with radiative losses of \qty{64}{\%} and \qty{30}{\%}, 
