\chapter{Facility design}
    ...
    \section{Version 2} \label{sec:design_v2}
        ...
        \missingfigure{Diagram of V2 in flowing and static configurations, like for V1}
        ...
        \begin{figure}[!ht]
            \centering
            \includegraphics[width=0.50\textwidth]{assets/3 design/V1 V2 comparison.png}
