\chapter{Introduction} \label{chp:intro}
    ...
    \section{Motivation}
        ...
        Initially, hydrogen propellant is introduced in the thrust chamber of the vehicle. The laser is focused inside the chamber (see \autoref{fig:LTP system overview}) and is absorbed by the gas via inverse Bremsstrahlung, creating a Laser-Sustained Plasma (LSP) core. Colder hydrogen flows around the LSP core and is heated by it to \qty{10000}{K}. The hot gas is then exhausted through a conventional converging-diverging nozzle at the exhaust velocity, imparting thrust to the vehicle.
    ...
    \section{Literature review}
        ...
        \begin{figure}[!ht]
            ...
            \end{subfigure}
            \caption{LSP setups from \textcite{takanoDemonstrationDiodeLasersustained2024}}
    ...
    \section{Summary and direction of work in this thesis}
        ...
        \begin{table}[!ht]
            ...
            \textcite{takanoDemonstrationDiodeLasersustained2024}         &2024&Diode    &0.927 and 0.951 &4.4 &\ce{Ar} & 6.0–20.0     & 105   & -    \\
        ...
        \begin{table}[!ht]
            ...
            \textcite{takanoDemonstrationDiodeLasersustained2024}  &       -       & $ \eta = \frac{g_0 I_\mathrm{sp} (F_\mathrm{hot}-F_\mathrm{cold})}{2 P_\mathrm{laser}} $ & 0.08 \\ 
        ...
        \begin{enumerate}
            \item A greater laser power to increase electron temperature, which gives greater inverse bremsstrahlung absorption coefficient and longer absorption path length;
        ...
        For a small-scale, demonstration thruster, $I_\mathrm{sp}$ values near \qty{100}{s} can be expected, with thrust values under \qty{1}{N}, as was found by \textcite{toyodaThrustPerformanceCW2002} and \textcite{takanoDemonstrationDiodeLasersustained2024}.
