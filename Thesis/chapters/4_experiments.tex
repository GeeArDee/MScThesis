\chapter{Experiments}
    ...
    \section{Static LSP validation}
        ...
        \subsection{V1 LSP spark initiation}
            ...
            Using the thickness of the electrode as a reference, the spark gap is XX mm high and the spark is X mm thick. \todo{Measure distance with thickness of electrode.}
        ...
        \subsection{V2 LSP spark initiation and QCW LSP}
            ...
            With the Photron SA5 looking into the front of the thruster at an angle, LSP initiation was confirmed in \todo{complete V2 initiation section, add photos} V2. 
        ...
        \subsection{Optical experiments: going from QCW to CW LSP}
            ...
            \end{figure}
            \todo{interpret graph, talk about way forward} Initiation at \qty{11}{\%} was attained once, but it was not possible to replicate this. A tighter focus was necessary to increase initiation \todo{add to this} reliability.

            Two ways can be used to calculate the spot size of a laser. Firstly, ray tracing software such as WinLens calculates the geometry of paraxial \footnote{Rays having small angles and distances to the optical axis} rays and shows the path of these rays at the focus. 
            ...
            \begin{table}[!ht]
                ...
                Double & 500, 150      &  110  &    0.08   &  6.80 \\ %calculations for this in C:\Users\gdub5\Documents\WinLens Files
                \bottomrule
                \end{tabularx}
            \end{table}
            ...
            The \autoref{fig:V2 threshold graph} presents the QCW LSP initiation attempts in V2 with focus distance. \qty{20}{bar} of argon was used for these shots.
            \begin{figure}[!ht]
                \centering
        ...
        \subsection{V2 CW LSP}
            ...
            This graph shows the pressure rise recorded by the PCB transducer connected to the oscilloscope. This was the first CW LSP generated in the lab. \todo{make better graph} Minimal damage to the window was noticed after this test.
    ...
    \section{V2 Cold flow thruster characterization}
        ...
        \subsection{Cold flow thrust tests}
            ...
            The empirical relation of pressure versus thrust is given \todo{Only 5 points is a bit thin to say its linear. Original plan was to have 35 points, but my SURE student can't seem to find where they put the data}by:
            \[
        ...
        \subsection{Needle valve effective sonic area $A^*$}
            ...
            The mass flow rate can then be derived by \todo{add here}
